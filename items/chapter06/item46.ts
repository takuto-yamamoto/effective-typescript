 ...
 *
 * - Understand the pros and cons of bundling types versus publishing them on DefinitelyTyped.
 * - Prefer bundling types if your library is written in TypeScript and DefinitelyTyped if it is not.
 */
